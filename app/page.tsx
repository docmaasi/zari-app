      ...
      <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8 text-sm text-zari-muted tracking-wide">
            ...
            <a href="#pricing" className="hover:text-zari-text transition-colors text-zari-accent">Pricing</a>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-sm text-zari-muted mb-6">Try Zari with real AI voices.</p>
              <ul className="space-y-3 text-sm">
                {[
                  ...
                  <li key={f.text} className={`flex items-center gap-2 ${f.ok ? "text-zari-text" : "text-zari-muted/40"}`}>
                    <span className={`w-4 h-4 rounded-full flex items-center justify-center text-[10px] ${f.ok ? "bg-green-500/20 text-green-400" : "bg-white/5 text-zari-muted/30"}`}>
                      {f.ok ? "✓" : "×"}
                    </span>
                    {f.text}
                  </li>
              ...
              <ul className="space-y-3 text-sm">
                {[
                  ...
                  <li key={f} className="flex items-center gap-2 text-zari-text">
                    <span className="w-4 h-4 rounded-full flex items-center justify-center text-[10px] bg-green-500/20 text-green-400">✓</span>
                    {f}
                  </li>
                ))}
              </ul>
